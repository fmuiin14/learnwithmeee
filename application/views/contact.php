	...
	<section class="contact-block">
		<div class="container">
			<header class="seperator-head text-center">
				<h2>Detail Kontak</h2>
				<p>Silakan, kami selalu mengharapkan kritik, saran, dan masukkan demi kemajuan kami.</p>
			</header>
			<div class="row">
				<div class="col-xs-12 col-sm-4">
					...
					<div class="detail-column">
						<span class="icn-wrap no-shrink element-block">
							<img src="<?= base_url('assets/') ?>images/icon11.png" alt="icon">
						</span>
				...
				<div class="col-xs-12 col-sm-4">
					...
					<div class="detail-column">
						<span class="icn-wrap no-shrink element-block">
							<img src="<?= base_url('assets/') ?>images/icon12.png" alt="icon">
						</span>
						<div class="descr-wrap">
				...
				<div class="col-xs-12 col-sm-4">
					...
					<div class="detail-column">
						<span class="icn-wrap no-shrink element-block">
							<img src="<?= base_url('assets/') ?>images/icon13.png" alt="icon">
						</span>
						<div class="descr-wrap">
		...
		<!-- mapHolder -->
		<div class="mapHolder">
			<iframe src="https://maps.google.com/maps?q=Depok&t=&z=13&ie=UTF8&iwloc=&output=embed" style="border:0" allowfullscreen="" width="100%" height="400" frameborder="0"></iframe>
			<span class="mapMarker">
				<img src="<?= base_url('assets/') ?>images/map-marker.png" alt="marker">
			</span>
		</div>
		<!-- btn aside block -->
