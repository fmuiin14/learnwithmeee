...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Tambah Data Pengajar</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('backend/pengajar/tambahDataPengajarAksi') ?>" method="POST" enctype="multipart/form-data">

                                <div class="form-group">
                                    <label>Nama Pengajar</label>
                                    <input type="text" value="<?= set_value('nama_pengajar') ?>" name="nama_pengajar" class="form-control">
